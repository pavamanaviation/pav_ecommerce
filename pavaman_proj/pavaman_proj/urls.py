...
from pavaman_backend.customer_views import (customer_register,customer_login,view_categories_and_discounted_products,
    ...
    view_customer_address,edit_customer_address,delete_customer_address,order_product_details,order_summary,order_multiple_products,multiple_order_summary,
    cancel_order,cancel_multiple_orders,
    view_category_and_subcategory_product_counts,filter_product_price,filter_product_price_each_category,sort_products_inside_subcategory,
    get_customer_details_by_admin,verify_email,resend_verification_email,google_login,
...
urlpatterns = [
    ...
    path('products/cancel-order',cancel_order,name='cancel_order'),
    path('products/cancel-multiple-orders',cancel_multiple_orders,name='cancel_multiple_orders'),

    path('category-and-subcategory-product-counts',view_category_and_subcategory_product_counts,name='view_category_and_subcategory_product_counts'),
